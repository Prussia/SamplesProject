 ...
 */
function updateForm(url, formId, listDatagrid, params, width, height) {
	var widthVal = (width == null)?600:width;
	var heightVal = (height == null)?400:height;
	var opts = {
		width : widthVal,
		height : heightVal,
		title : '信息',
 ...
 * @param params
 */
function view(url, params, width, height) {
	var widthVal = (width == null)?600:width;
	var heightVal = (height == null)?400:height;
	var opts = {
		width : widthVal,
