...
public  class SystemLogAspect {    
    ...
    //Service层切点    
    @Pointcut("@annotation(com.infotop.app.annotationtest.SystemServiceLog)")    
     public  void serviceAspect() {    
    }    
    
    //Controller层切点    
    @Pointcut("@annotation(com.infotop.app.annotationtest.SystemControllerLog)")    
    ...
    @Before("controllerAspect()")    
     public  void doBefore(JoinPoint joinPoint) {    
      ...
      /*      Log log = SpringContextHolder.getBean("logxx");    
            ...
            log.setOperateDate(DateTimeUtil.nowTimeStr());
